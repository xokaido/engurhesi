...
export const procurements = sqliteTable('procurements', {
  ...
  /** announcement number on the state procurement portal, e.g. NAT260012662 */
  tenderNumber: text('tender_number'),
  /** deep link to the announcement on tenders.procurement.gov.ge */
  tenderUrl: text('tender_url'),
